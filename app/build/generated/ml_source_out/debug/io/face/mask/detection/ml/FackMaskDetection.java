package io.face.mask.detection.ml;
...
/**
 * Identify the most prominent object in the image from a set of 1001 categories. */
public final class FackMaskDetection {
  @NonNull
  ...
  private FackMaskDetection(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "fack_mask_detection.tflite", options);
  ...
  @NonNull
  public static FackMaskDetection newInstance(@NonNull Context context) throws IOException {
    return new FackMaskDetection(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FackMaskDetection newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new FackMaskDetection(context, options);
  }
